...
# [<img src=".bluebeluga.png" height="100" width="200" style="border-radius: 50%;" alt="@fancyremarker" />](https://github.com/blue-beluga/docker-chef-server) bluebeluga/chef-server

Alpine Linux image with Chef Server.
